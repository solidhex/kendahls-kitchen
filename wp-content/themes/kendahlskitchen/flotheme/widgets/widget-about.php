 ...
 * Blog Widget 
 */
class Flotheme_About_Widget extends WP_Widget 
{
	...
	public function __construct() {
		...
		/* Widget settings. */
		$widget_ops = array(
			'classname' => 'flo_about_widget', 
			'description' => __('A widget that displays a short information about you.', 'flotheme') 
		);
		...
		$control_ops = array(
			'width'		=> 500, 
			'height'	=> 450, 
			'id_base'	=> 'flo_about_widget' 
		);

		/* Create the widget. */
		$this->WP_Widget( 'flo_about_widget', __('Flotheme About Me', 'flotheme'), $widget_ops, $control_ops );
	}
	...
	public function widget( $args, $instance ) 
	{
		...
		$image = new Flotheme_WidgetImageField( $this, $image_id );
        ...
        <?php /* Display the widget title if one was input (before and after defined by themes). */
				...
				?>
			<div class="flotheme-about-widget">
